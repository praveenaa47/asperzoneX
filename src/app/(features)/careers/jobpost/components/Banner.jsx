                ...
                <div className="relative flex items-center justify-center h-full px-4 sm:px-8 md:px-10">
                  <div className="text-center text-white max-w-3xl md:max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6">
                      ...
                      <button
                      onClick={()=>router.push("/careers/jobpost")}
                      className="bg-gray-800  text-white font-medium text-sm sm:text-base px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md flex items-center gap-2">
