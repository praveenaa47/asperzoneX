...
export default function ConsultingHero( { title, subtitle, bannerImage }) {
  ...
  return (
    <>
      ...
      {/* Description Section */}
      <div className="text-center px-4 sm:px-8 mt-4 sm:mt-8">
        <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl italic text-blue-600 font-normal leading-relaxed">
          From Undergraduate Programs To{" "}
          <span className="font-semibold">
            master’s abroad, and from scholarships to career guidance — our
            Higher Education services support you at every stage with
            personalized care,
          </span>{" "}
          optimize your operations, our Finance & Business services guide you
          every step{" "}
          <span className="font-semibold">
            with transparent guidance tailored to your goals
          </span>
