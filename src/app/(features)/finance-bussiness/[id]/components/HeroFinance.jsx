  ...
  return (
    <>
      ...
      <div className="text-center px-4 -mt-3">
        <h2 className="text-2xl md:text-3xl lg:text-3xl italic text-blue-600 font-medium leading-relaxed">
          Whether <span className="font-semibold">you're starting a business, need help with financial planning, or want to </span>{" "}
          optimize your operations, our Finance & Business services guide you every step{" "}
          <span className="font-semibold">Transparent, Custom</span> To{" "}
          <span className="font-semibold">Advisory</span>, Built to Your 
          Goals.
        </h2>
      </div>
    </>
