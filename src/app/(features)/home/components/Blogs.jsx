...
const dispatch = useDispatch();
  ...
  return (
      ...
      <div className="md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-6 mb-8 flex md:flex-none overflow-x-auto gap-4 pb-4 snap-x snap-mandatory scrollbar-hide p-10">
