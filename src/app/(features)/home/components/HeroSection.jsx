...
import { ChevronDown, Search, Users, Car, Plane, Home, Heart, ShoppingBag } from 'lucide-react';
...
const HeroSection = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: ShoppingBag,
      label: 'Consulting',
      options: ['Contact Advisor', 'Schedule Meeting', 'Business Solutions']
    },
    {
      id: 'buy-property',
      icon: Heart,
    ...
    },
    {
      ...
      icon: Car,
      label: 'Sell Car',
      options: ['Add Listing', 'View Offers', 'Sell Online']
    },
    {
      id: 'career-guidance',
      icon: Users,
      label: 'Career Guidance',
      options: ['Colleagues', 'Colleges', 'Job Opportunities']
    }
  ];
