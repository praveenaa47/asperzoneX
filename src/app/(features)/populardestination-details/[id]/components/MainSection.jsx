  ...
  return (
    <>
      ...
      <div className="text-center px-4 mb-4">
        <h2 className="text-xl md:text-2xl lg:text-xl text-black font-normal ">
          From Undergraduate Programs To master’s abroad, and from scholarships to career guidance — our Higher Education services support you at every stage with personalized c{" "}
          optimize your operations, our Finance & Business services guide you every step{" "}
          master’s abroad, and from scholarships to career guidance — our Higher Education services support you at every stage with personalized c To{" "}
          and transparent guidance tailored to your goals, Built to Your you
          Goals.
        </h2>
      </div>
    </>
