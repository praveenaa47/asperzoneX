          ...
          <div className="lg:col-span-2 space-y-4">
              ...
              <div className="hidden md:flex flex-col gap-2">
                {images[1] && (
                  <div className="flex-1 relative rounded-xl overflow-hidden">
                    <img
                      src={images[1]}
                      alt={property?.propertyName || "Property view"}
                      className="w-full h-full object-cover"
                    />
                  </div>
                )}
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                {property?.propertyName || "10 Marla Double Storey House"}
              </h1>
              <p className="text-3xl md:text-4xl font-bold text-blue-600 mb-4">
                Rs {property?.price?.amount?.toLocaleString() || "3.2 Core"}
                {property?.price?.period === "monthly" && (
              ...
              <div className="flex items-center text-gray-600 mb-4">
                ...
                <span>
                  {property?.location?.formatted || "Gulshan Abad, Rawalpindi"}
                </span>
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm sticky top-6 space-y-6">
              ...
              <div className="flex items-center gap-4 pb-6 border-b border-gray-200">
                <img
                  ...
                  alt={property?.postedBy?.id?.name || "Agent"}
                  className="w-14 h-14 rounded-full object-cover"
                />
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900">
                    {property?.postedBy?.id?.name || "Emily Carter"}
                  </h3>
                  <p className="text-sm text-gray-500">
                    {property?.postedBy?.type || "Real Estate Agent"}
                  </p>
                </div>
              </div>
