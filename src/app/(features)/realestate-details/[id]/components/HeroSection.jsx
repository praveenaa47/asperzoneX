            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="grid grid-cols-4 gap-2 h-80 md:h-96">
                ...
                <div className="col-span-4 md:col-span-3 relative rounded-2xl overflow-hidden group">
                  <img 
                    src={images[0]} 
                    alt={property?.title || "Property main view"} 
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                 {property?.title || "10 Marla Double Storey House"}
                 </h1>
                ...
                <div className="flex items-center text-gray-600 mb-4">
                  ...
                  <span>{property?.location?.address || "Gulshan Abad, Rawalpindi"}</span>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6 border-t border-gray-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900"> {property?.bedrooms || "4"}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{property?.bathrooms || "3"}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">  {property?.area?.value || "2200"} {property?.area?.unit || "Sqft"}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900"> {property?.parking || "2"} Car</p>
                    </div>
                  </div>
                </div>
              </div>
