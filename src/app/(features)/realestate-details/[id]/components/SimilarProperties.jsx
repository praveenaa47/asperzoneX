  ...
  return (
    <section className="py-12 sm:py-16 lg:py-3 bg-white">
      <div className=" px-4 sm:px-6 lg:px-10">
        ...
        {/* Properties Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-2">
            ...
            >
              ...
              <div className="relative h-56 sm:h-64 overflow-hidden">
                <img
                  src={property.image}
                  alt={property.title}
                  className="w-160 h-100 object-cover group-hover:scale-110 transition-transform duration-500"
                />
              ...
              <div className="p-5 sm:p-6">
                ...
                {/* Features */}
                <div className="flex items-center gap-4 mb-2 pb-4 border-b border-gray-200">
