...
<div className="space-y-4">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div>
      ...
      <select className="w-full bg-white text-black px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    {/* Passenger Capacity Counter */}
    <div>
      <label className="block text-sm font-medium text-gray-700 mb-2">Passenger Capacity</label>
      <div className="flex items-center justify-between border border-gray-300 rounded-lg bg-white px-2 py-2">
        <button className="text-blue-600 font-bold text-lg hover:bg-blue-100 w-8 h-8 rounded-full flex items-center justify-center">-</button>
        <span className="text-gray-900 font-medium text-lg select-none">4</span>
        <button className="text-blue-600 font-bold text-lg hover:bg-blue-100 w-8 h-8 rounded-full flex items-center justify-center">+</button>
      </div>
    </div>
    ...
    <div>
      ...
      <input
        className="w-full bg-white text-black px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
      />
    </div>
  </div>
  ...
  <div>
    ...
    <textarea
      rows="3"
      className="w-full bg-white text-black px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none resize-none"
      ...
      <div className="bg-[#F6F6F6] rounded-lg shadow-sm p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select className="w-full bg-white  px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none">
              <option>Select Option</option>
            </select>
          </div>
          <div>
