    ...
    <div className=" px-4 py-10 ">
      ...
      <div className="border-2 border-gray-300 rounded-2xl p-8 md:p-12 bg-white">
        ...
        onClick={()=>router.push("/conatctus")} 
         className="flex items-center gap-2 px-6 py-3 border-2 border-gray-800 text-gray-800 font-semibold rounded-lg hover:bg-gray-800 hover:text-white transition-colors duration-300">
          Know More
