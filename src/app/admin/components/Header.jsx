  ...
  return (
    <header className="bg-white border-b border-gray-200 flex items-center justify-between p-4 relative">
      ...
      <div className="flex items-center space-x-4">
        {/* Notification Bell */}
        <button className="relative p-2 text-blue-500 bg-blue-100 rounded-lg cursor-pointer hover:bg-blue-200 transition-colors">
          <Bell size={20} />
        ...
        {/* Profile Section */}
        <div className="flex items-center cursor-pointer hover:bg-gray-100 rounded-lg p-1 transition-colors">
